    ...
    return (
        <footer>
            ...
            <div className="footer-links">
                ...
                {/* eslint-disable-next-line */}
                <a href="#" className="footer-link">Brand Links</a>
                {/* eslint-disable-next-line */}
            ...
            <div className="social-links">
                {/* eslint-disable-next-line */}
                <a href="#" className="social-link" aria-label="Link to facebook page">
                ...
                {/* eslint-disable-next-line */}
                <a href="#" className="social-link" aria-label="Link to twitter page">
                ...
                {/* eslint-disable-next-line */}
                <a href="#" className="social-link" aria-label="Link to pinterest page">
                ...
                {/* eslint-disable-next-line */}
                <a href="#" className="social-link" aria-label="Link to instagram page">
